...
mod tests {
    ...
    fn event_serializes_to_safe_shared_fields() {
        ...
        assert_eq!(v["action"], "hindsight.incident.open");
        assert_eq!(v["source"], "hindsight");
